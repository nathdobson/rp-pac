...
impl UsbDpram {
    ...
    pub const fn ep_out_control(
        ...
        assert!(n < 15usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0cusize + n * 8usize) as _) }
    }
    ...
    pub const fn ep_in_buffer_control(
        ...
        assert!(n < 16usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x80usize + n * 8usize) as _) }
    }
    #[doc = "Buffer control for both buffers of an endpoint. Fields ending in a _1 are for buffer 1. Fields ending in a _0 are for buffer 0. Buffer 1 controls are only valid if the endpoint is in double buffered mode."]
    #[inline(always)]
    pub const fn ep_out_buffer_control(
        ...
        assert!(n < 16usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x84usize + n * 8usize) as _) }
    }
}
pub mod regs;
pub mod vals;
