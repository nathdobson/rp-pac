...
impl defmt::Format for Peripherals {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Peripherals {{ adc: {=bool:?}, busctrl: {=bool:?}, dma: {=bool:?}, i2c0: {=bool:?}, i2c1: {=bool:?}, io_bank0: {=bool:?}, io_qspi: {=bool:?}, jtag: {=bool:?}, pads_bank0: {=bool:?}, pads_qspi: {=bool:?}, pio0: {=bool:?}, pio1: {=bool:?}, pll_sys: {=bool:?}, pll_usb: {=bool:?}, pwm: {=bool:?}, rtc: {=bool:?}, spi0: {=bool:?}, spi1: {=bool:?}, syscfg: {=bool:?}, sysinfo: {=bool:?}, tbman: {=bool:?}, timer: {=bool:?}, uart0: {=bool:?}, uart1: {=bool:?}, usbctrl: {=bool:?} }}" , self . adc () , self . busctrl () , self . dma () , self . i2c0 () , self . i2c1 () , self . io_bank0 () , self . io_qspi () , self . jtag () , self . pads_bank0 () , self . pads_qspi () , self . pio0 () , self . pio1 () , self . pll_sys () , self . pll_usb () , self . pwm () , self . rtc () , self . spi0 () , self . spi1 () , self . syscfg () , self . sysinfo () , self . tbman () , self . timer () , self . uart0 () , self . uart1 () , self . usbctrl ())
    }
}
