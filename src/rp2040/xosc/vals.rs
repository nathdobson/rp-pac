...
impl CtrlFreqRange {
    ...
    pub const Reserved1: Self = Self(0x0aa1);
    pub const Reserved2: Self = Self(0x0aa2);
    pub const Reserved3: Self = Self(0x0aa3);
}
impl CtrlFreqRange {
...
impl core::fmt::Debug for CtrlFreqRange {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self.0 {
            ...
            0x0aa1 => f.write_str("Reserved1"),
            0x0aa2 => f.write_str("Reserved2"),
            0x0aa3 => f.write_str("Reserved3"),
...
impl defmt::Format for CtrlFreqRange {
    fn format(&self, f: defmt::Formatter) {
        match self.0 {
            ...
            0x0aa1 => defmt::write!(f, "Reserved1"),
            0x0aa2 => defmt::write!(f, "Reserved2"),
            0x0aa3 => defmt::write!(f, "Reserved3"),
