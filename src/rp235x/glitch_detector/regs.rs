...
impl Arm {
    ...
    #[inline(always)]
    pub const fn set_arm(&mut self, val: super::vals::Arm) {
...
impl defmt::Format for Arm {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Arm {{ arm: {:?} }}", self.arm())
    }
}
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
...
impl Disarm {
    ...
    #[doc = "Forcibly disarm the glitch detectors, if they are armed by OTP. Ignored if ARM is YES. This register is Secure read/write only."]
    #[inline(always)]
    pub const fn set_disarm(&mut self, val: super::vals::Disarm) {
        self.0 = (self.0 & !(0xffff << 0usize)) | (((val.to_bits() as u32) & 0xffff) << 0usize);
    }
}
...
impl defmt::Format for Disarm {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Disarm {{ disarm: {:?} }}", self.disarm())
    }
}
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
...
impl defmt::Format for Lock {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Lock {{ lock: {=u8:?} }}", self.lock())
    }
}
...
impl Sensitivity {
    ...
    #[doc = "Set sensitivity for detector 0. Higher values are more sensitive."]
    #[inline(always)]
    pub const fn set_det0(&mut self, val: u8) {
    ...
    #[doc = "Set sensitivity for detector 1. Higher values are more sensitive."]
    #[inline(always)]
    pub const fn set_det1(&mut self, val: u8) {
    ...
    #[doc = "Set sensitivity for detector 2. Higher values are more sensitive."]
    #[inline(always)]
    pub const fn set_det2(&mut self, val: u8) {
    ...
    #[doc = "Set sensitivity for detector 3. Higher values are more sensitive."]
    #[inline(always)]
    pub const fn set_det3(&mut self, val: u8) {
    ...
    #[doc = "Must be the inverse of DET0, else the default value is used."]
    #[inline(always)]
    pub const fn set_det0_inv(&mut self, val: u8) {
    ...
    #[doc = "Must be the inverse of DET1, else the default value is used."]
    #[inline(always)]
    pub const fn set_det1_inv(&mut self, val: u8) {
    ...
    #[doc = "Must be the inverse of DET2, else the default value is used."]
    #[inline(always)]
    pub const fn set_det2_inv(&mut self, val: u8) {
    ...
    #[doc = "Must be the inverse of DET3, else the default value is used."]
    #[inline(always)]
    pub const fn set_det3_inv(&mut self, val: u8) {
    ...
    #[inline(always)]
    pub const fn set_default(&mut self, val: super::vals::Default) {
...
impl defmt::Format for Sensitivity {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Sensitivity {{ det0: {=u8:?}, det1: {=u8:?}, det2: {=u8:?}, det3: {=u8:?}, det0_inv: {=u8:?}, det1_inv: {=u8:?}, det2_inv: {=u8:?}, det3_inv: {=u8:?}, default: {:?} }}" , self . det0 () , self . det1 () , self . det2 () , self . det3 () , self . det0_inv () , self . det1_inv () , self . det2_inv () , self . det3_inv () , self . default ())
    }
}
...
impl TrigForce {
    ...
    #[inline(always)]
    pub const fn set_trig_force(&mut self, val: u8) {
...
impl defmt::Format for TrigForce {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "TrigForce {{ trig_force: {=u8:?} }}", self.trig_force())
    }
}
...
impl TrigStatus {
    ...
    #[inline(always)]
    pub const fn set_det0(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_det1(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_det2(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_det3(&mut self, val: bool) {
...
impl defmt::Format for TrigStatus {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "TrigStatus {{ det0: {=bool:?}, det1: {=bool:?}, det2: {=bool:?}, det3: {=bool:?} }}",
            self.det0(),
            self.det1(),
            self.det2(),
            self.det3()
