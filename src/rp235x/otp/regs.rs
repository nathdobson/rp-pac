...
impl Archsel {
    ...
    #[doc = "Select architecture for core 0."]
    #[inline(always)]
    pub const fn set_core0(&mut self, val: super::vals::ArchselCore0) {
    ...
    #[doc = "Select architecture for core 1."]
    #[inline(always)]
    pub const fn set_core1(&mut self, val: super::vals::ArchselCore1) {
...
impl ArchselStatus {
    ...
    #[doc = "Current architecture for core 0. Updated on processor warm reset."]
    #[inline(always)]
    pub const fn set_core0(&mut self, val: super::vals::ArchselStatusCore0) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "Current architecture for core 0. Updated on processor warm reset."]
    #[must_use]
    ...
    #[doc = "Current architecture for core 0. Updated on processor warm reset."]
    #[inline(always)]
    pub const fn set_core1(&mut self, val: super::vals::ArchselStatusCore1) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
}
...
impl defmt::Format for Bist {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Bist {{ cnt: {=u16:?}, cnt_max: {=u16:?}, cnt_ena: {=bool:?}, cnt_clr: {=bool:?}, cnt_fail: {=bool:?} }}" , self . cnt () , self . cnt_max () , self . cnt_ena () , self . cnt_clr () , self . cnt_fail ())
    }
}
...
impl Critical {
    ...
    #[inline(always)]
    pub const fn set_default_archsel(&mut self, val: bool) {
...
impl defmt::Format for Dbg {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Dbg {{ psm_done: {=bool:?}, boot_done: {=bool:?}, rosc_up_seen: {=bool:?}, rosc_up: {=bool:?}, psm_state: {=u8:?}, customer_rma_flag: {=bool:?} }}" , self . psm_done () , self . boot_done () , self . rosc_up_seen () , self . rosc_up () , self . psm_state () , self . customer_rma_flag ())
    }
}
...
impl Debugen {
    ...
    #[doc = "Permit core 0's Mem-AP to generate Secure accesses, assuming it is enabled at all. Also enable secure debug of core 0 (SPIDEN and SPNIDEN). Secure debug of core 0 is disabled by default if the secure debug disable critical flag is set, or if at least one debug key has been enrolled and the most secure of these enrolled key values not yet provided over SWD. Note also that core Mem-APs are unconditionally disabled when a core is switched to RISC-V mode (by setting the ARCHSEL bit and performing a warm reset of the core)."]
    #[inline(always)]
    pub const fn set_proc0_secure(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
    }
    ...
    #[doc = "Permit core 1's Mem-AP to generate Secure accesses, assuming it is enabled at all. Also enable secure debug of core 1 (SPIDEN and SPNIDEN). Secure debug of core 1 is disabled by default if the secure debug disable critical flag is set, or if at least one debug key has been enrolled and the most secure of these enrolled key values not yet provided over SWD."]
    #[inline(always)]
    pub const fn set_proc1_secure(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
    }
...
impl defmt::Format for Debugen {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Debugen {{ proc0: {=bool:?}, proc0_secure: {=bool:?}, proc1: {=bool:?}, proc1_secure: {=bool:?}, misc: {=bool:?} }}" , self . proc0 () , self . proc0_secure () , self . proc1 () , self . proc1_secure () , self . misc ())
    }
}
...
impl Int {
    ...
    #[inline(always)]
    pub const fn set_sbpi_flag_n(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
    }
    #[must_use]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn set_sbpi_wr_fail(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
    }
    #[must_use]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn set_apb_dctrl_fail(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
    }
    #[must_use]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn set_apb_rd_sec_fail(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
    }
    #[must_use]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn set_apb_rd_nsec_fail(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
    }
}
...
impl defmt::Format for KeyValid {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "KeyValid {{ key_valid: {=u8:?} }}", self.key_valid())
    }
}
...
impl defmt::Format for SbpiInstr {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "SbpiInstr {{ short_wdata: {=u8:?}, cmd: {=u8:?}, target: {=u8:?}, payload_size_m1: {=u8:?}, has_payload: {=bool:?}, is_wr: {=bool:?}, exec: {=bool:?} }}" , self . short_wdata () , self . cmd () , self . target () , self . payload_size_m1 () , self . has_payload () , self . is_wr () , self . exec ())
    }
}
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
...
impl defmt::Format for SbpiStatus {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "SbpiStatus {{ rdata_vld: {=bool:?}, instr_done: {=bool:?}, instr_miss: {=bool:?}, flag: {=bool:?}, miso: {=u8:?} }}" , self . rdata_vld () , self . instr_done () , self . instr_miss () , self . flag () , self . miso ())
    }
}
...
impl SwLock {
    ...
    #[doc = "Secure lock status. Writes are OR'd with the current value. This field is read-only to Non-secure code."]
    #[inline(always)]
    pub const fn set_sec(&mut self, val: super::vals::SwLockSec) {
    ...
    #[doc = "Non-secure lock status. Writes are OR'd with the current value."]
    #[inline(always)]
    pub const fn set_nsec(&mut self, val: super::vals::SwLockNsec) {
...
impl Usr {
    ...
    #[doc = "1 enables USER interface; 0 disables USER interface (enables SBPI). This bit must be cleared before performing any SBPI access, such as when programming the OTP. The APB data read interface (USER interface) will be inaccessible during this time, and will return a bus error if any read is attempted."]
    #[inline(always)]
    pub const fn set_dctrl(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
    }
