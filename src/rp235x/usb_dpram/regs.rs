...
impl EpBufferControl {
    ...
    #[doc = "The length of the data in buffer 1."]
    #[inline(always)]
    pub const fn set_length(&mut self, n: usize, val: u16) {
        assert!(n < 2usize);
        let offs = 0usize + n * 16usize;
    ...
    #[doc = "Buffer 0 is available. This bit is set to indicate the buffer can be used by the controller. The controller clears the available bit when writing the status back."]
    #[inline(always)]
    pub const fn set_available(&mut self, n: usize, val: bool) {
        assert!(n < 2usize);
        let offs = 10usize + n * 16usize;
    ...
    #[doc = "Buffer 0 is the last buffer of the transfer."]
    #[inline(always)]
    pub const fn set_last(&mut self, n: usize, val: bool) {
        assert!(n < 2usize);
        let offs = 14usize + n * 16usize;
        self.0 = (self.0 & !(0x01 << offs)) | (((val as u32) & 0x01) << offs);
    }
    ...
    #[doc = "Buffer 0 is full. For an IN transfer (TX to the host) the bit is set to indicate the data is valid. For an OUT transfer (RX from the host) this bit should be left as a 0. The host will set it when it has filled the buffer with data."]
    #[inline(always)]
    pub const fn set_full(&mut self, n: usize, val: bool) {
        assert!(n < 2usize);
        let offs = 15usize + n * 16usize;
        self.0 = (self.0 & !(0x01 << offs)) | (((val as u32) & 0x01) << offs);
    }
    ...
    #[doc = "The number of bytes buffer 1 is offset from buffer 0 in Isochronous mode. Only valid in double buffered mode for an Isochronous endpoint. For a non Isochronous endpoint the offset is always 64 bytes."]
    #[inline(always)]
    pub const fn set_double_buffer_iso_offset(
        &mut self,
...
impl core::fmt::Debug for EpBufferControl {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("EpBufferControl")
            .field("length[0]", &self.length(0usize))
            .field("length[1]", &self.length(1usize))
            .field("available[0]", &self.available(0usize))
            .field("available[1]", &self.available(1usize))
            .field("stall", &self.stall())
            .field("reset", &self.reset())
            .field("pid[0]", &self.pid(0usize))
            .field("pid[1]", &self.pid(1usize))
            .field("last[0]", &self.last(0usize))
            .field("last[1]", &self.last(1usize))
            .field("full[0]", &self.full(0usize))
            .field("full[1]", &self.full(1usize))
...
impl defmt::Format for EpBufferControl {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "EpBufferControl {{ length[0]: {=u16:?}, length[1]: {=u16:?}, available[0]: {=bool:?}, available[1]: {=bool:?}, stall: {=bool:?}, reset: {=bool:?}, pid[0]: {=bool:?}, pid[1]: {=bool:?}, last[0]: {=bool:?}, last[1]: {=bool:?}, full[0]: {=bool:?}, full[1]: {=bool:?}, double_buffer_iso_offset: {:?} }}" , self . length (0usize) , self . length (1usize) , self . available (0usize) , self . available (1usize) , self . stall () , self . reset () , self . pid (0usize) , self . pid (1usize) , self . last (0usize) , self . last (1usize) , self . full (0usize) , self . full (1usize) , self . double_buffer_iso_offset ())
    }
}
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
...
impl EpControl {
    ...
    #[doc = "64 byte aligned buffer address for this EP (bits 0-5 are ignored). Relative to the start of the DPRAM."]
    #[inline(always)]
    pub const fn set_buffer_address(&mut self, val: u16) {
    ...
    #[doc = "Trigger an interrupt if a NAK is sent. Intended for debug only."]
    #[inline(always)]
    pub const fn set_interrupt_on_nak(&mut self, val: bool) {
    ...
    #[doc = "Trigger an interrupt if a STALL is sent. Intended for debug only."]
    #[inline(always)]
    pub const fn set_interrupt_on_stall(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_endpoint_type(&mut self, val: super::vals::EpControlEndpointType) {
    ...
    #[doc = "Trigger an interrupt each time both buffers are done. Only valid in double buffered mode."]
    #[inline(always)]
    pub const fn set_interrupt_per_double_buff(&mut self, val: bool) {
    ...
    #[doc = "Trigger an interrupt each time a buffer is done."]
    #[inline(always)]
    pub const fn set_interrupt_per_buff(&mut self, val: bool) {
    ...
    #[doc = "This endpoint is double buffered."]
    #[inline(always)]
    pub const fn set_double_buffered(&mut self, val: bool) {
...
impl defmt::Format for EpControl {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "EpControl {{ buffer_address: {=u16:?}, interrupt_on_nak: {=bool:?}, interrupt_on_stall: {=bool:?}, endpoint_type: {:?}, interrupt_per_double_buff: {=bool:?}, interrupt_per_buff: {=bool:?}, double_buffered: {=bool:?}, enable: {=bool:?} }}" , self . buffer_address () , self . interrupt_on_nak () , self . interrupt_on_stall () , self . endpoint_type () , self . interrupt_per_double_buff () , self . interrupt_per_buff () , self . double_buffered () , self . enable ())
    }
}
...
impl SetupPacketHigh {
    ...
    #[inline(always)]
    pub const fn set_wlength(&mut self, val: u16) {
...
impl defmt::Format for SetupPacketHigh {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SetupPacketHigh {{ windex: {=u16:?}, wlength: {=u16:?} }}",
            self.windex(),
            self.wlength()
        )
    }
...
impl defmt::Format for SetupPacketLow {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SetupPacketLow {{ bmrequesttype: {=u8:?}, brequest: {=u8:?}, wvalue: {=u16:?} }}",
            self.bmrequesttype(),
            self.brequest(),
            self.wvalue()
        )
