...
impl Dma {
    ...
    pub const fn intr(self, n: usize) -> crate::common::Reg<u32, crate::common::RW> {
        assert!(n < 4usize);
        unsafe {
            crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0400usize + n * 16usize) as _)
        }
    }
    ...
    pub const fn inte(self, n: usize) -> crate::common::Reg<u32, crate::common::RW> {
        assert!(n < 4usize);
        unsafe {
            crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0404usize + n * 16usize) as _)
        }
    }
    ...
    pub const fn intf(self, n: usize) -> crate::common::Reg<u32, crate::common::RW> {
        assert!(n < 4usize);
        unsafe {
            crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0408usize + n * 16usize) as _)
        }
    }
    ...
    pub const fn ints(self, n: usize) -> crate::common::Reg<u32, crate::common::RW> {
        assert!(n < 4usize);
        unsafe {
            crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x040cusize + n * 16usize) as _)
        }
    }
    ...
    pub const fn mpu_bar(self, n: usize) -> crate::common::Reg<u32, crate::common::RW> {
        assert!(n < 8usize);
        unsafe {
            crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0504usize + n * 8usize) as _)
        }
    }
    ...
    pub const fn mpu_lar(self, n: usize) -> crate::common::Reg<u32, crate::common::RW> {
        assert!(n < 8usize);
        unsafe {
            crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0508usize + n * 8usize) as _)
        }
    }
}
pub mod regs;
