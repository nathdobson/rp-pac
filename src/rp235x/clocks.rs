...
impl Clocks {
    ...
    pub const fn clk_gpout_ctrl(
        ...
        assert!(n < 4usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0usize + n * 12usize) as _) }
    }
    #[inline(always)]
    pub const fn clk_gpout_div(
        ...
        assert!(n < 4usize);
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x04usize + n * 12usize) as _) }
    }
    ...
    pub const fn clk_gpout_selected(
        self,
        n: usize,
    ) -> crate::common::Reg<regs::ClkGpoutSelected, crate::common::RW> {
        assert!(n < 4usize);
