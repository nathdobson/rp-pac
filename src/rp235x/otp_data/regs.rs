...
impl BootselLedCfg {
    ...
    #[doc = "LED is active-low. (Default: active-high.)."]
    #[inline(always)]
    pub const fn set_activelow(&mut self, val: bool) {
...
impl defmt::Format for BootselLedCfg {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "BootselLedCfg {{ pin: {=u8:?}, activelow: {=bool:?} }}",
            self.pin(),
            self.activelow()
        )
    }
...
impl BootselPllCfg {
    ...
    #[doc = "PLL reference divisor, minus one. Programming a value of 0 means a reference divisor of 1. Programming a value of 1 means a reference divisor of 2 (for exceptionally fast XIN inputs)."]
    #[inline(always)]
    pub const fn set_refdiv(&mut self, val: bool) {
...
impl defmt::Format for BootselPllCfg {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "BootselPllCfg {{ fbdiv: {=u16:?}, postdiv1: {=u8:?}, postdiv2: {=u8:?}, refdiv: {=bool:?} }}" , self . fbdiv () , self . postdiv1 () , self . postdiv2 () , self . refdiv ())
    }
}
...
impl NumGpios {
    ...
    #[inline(always)]
    pub const fn set_num_gpios(&mut self, val: u8) {
...
impl defmt::Format for NumGpios {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "NumGpios {{ num_gpios: {=u8:?} }}", self.num_gpios())
    }
}
