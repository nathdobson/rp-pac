...
impl Peripherals {
    ...
    #[inline(always)]
    pub const fn set_busctrl(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_hstx(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_io_bank0(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_io_qspi(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_pads_bank0(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_pads_qspi(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_pio0(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_pio1(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_pio2(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_pll_sys(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_pll_usb(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_sha256(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_spi0(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_sysinfo(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_tbman(&mut self, val: bool) {
    ...
    #[inline(always)]
    pub const fn set_usbctrl(&mut self, val: bool) {
...
impl defmt::Format for Peripherals {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Peripherals {{ adc: {=bool:?}, busctrl: {=bool:?}, dma: {=bool:?}, hstx: {=bool:?}, i2c0: {=bool:?}, i2c1: {=bool:?}, io_bank0: {=bool:?}, io_qspi: {=bool:?}, jtag: {=bool:?}, pads_bank0: {=bool:?}, pads_qspi: {=bool:?}, pio0: {=bool:?}, pio1: {=bool:?}, pio2: {=bool:?}, pll_sys: {=bool:?}, pll_usb: {=bool:?}, pwm: {=bool:?}, sha256: {=bool:?}, spi0: {=bool:?}, spi1: {=bool:?}, syscfg: {=bool:?}, sysinfo: {=bool:?}, tbman: {=bool:?}, timer0: {=bool:?}, timer1: {=bool:?}, trng: {=bool:?}, uart0: {=bool:?}, uart1: {=bool:?}, usbctrl: {=bool:?} }}" , self . adc () , self . busctrl () , self . dma () , self . hstx () , self . i2c0 () , self . i2c1 () , self . io_bank0 () , self . io_qspi () , self . jtag () , self . pads_bank0 () , self . pads_qspi () , self . pio0 () , self . pio1 () , self . pio2 () , self . pll_sys () , self . pll_usb () , self . pwm () , self . sha256 () , self . spi0 () , self . spi1 () , self . syscfg () , self . sysinfo () , self . tbman () , self . timer0 () , self . timer1 () , self . trng () , self . uart0 () , self . uart1 () , self . usbctrl ())
    }
}
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
...
impl defmt::Format for Wdsel {
    fn format(&self, f: defmt::Formatter) {
        defmt :: write ! (f , "Wdsel {{ adc: {=bool:?}, busctrl: {=bool:?}, dma: {=bool:?}, hstx: {=bool:?}, i2c0: {=bool:?}, i2c1: {=bool:?}, io_bank0: {=bool:?}, io_qspi: {=bool:?}, jtag: {=bool:?}, pads_bank0: {=bool:?}, pads_qspi: {=bool:?}, pio0: {=bool:?}, pio1: {=bool:?}, pio2: {=bool:?}, pll_sys: {=bool:?}, pll_usb: {=bool:?}, pwm: {=bool:?}, sha256: {=bool:?}, spi0: {=bool:?}, spi1: {=bool:?}, syscfg: {=bool:?}, sysinfo: {=bool:?}, tbman: {=bool:?}, timer0: {=bool:?}, timer1: {=bool:?}, trng: {=bool:?}, uart0: {=bool:?}, uart1: {=bool:?}, usbctrl: {=bool:?} }}" , self . adc () , self . busctrl () , self . dma () , self . hstx () , self . i2c0 () , self . i2c1 () , self . io_bank0 () , self . io_qspi () , self . jtag () , self . pads_bank0 () , self . pads_qspi () , self . pio0 () , self . pio1 () , self . pio2 () , self . pll_sys () , self . pll_usb () , self . pwm () , self . sha256 () , self . spi0 () , self . spi1 () , self . syscfg () , self . sysinfo () , self . tbman () , self . timer0 () , self . timer1 () , self . trng () , self . uart0 () , self . uart1 () , self . usbctrl ())
    }
}
